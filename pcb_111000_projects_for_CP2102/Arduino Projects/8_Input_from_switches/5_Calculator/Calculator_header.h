...
#define message_1 "\r\nFPN from IO\r\n\
Hold sw_1 down to populate digit_0 and press sw_3 to insert decimal point.\r\n\
Press sw2 to shift the display left\r\n\
Press sw_3 to enter the number and sw1 to do some arithmetic.\r\n\
